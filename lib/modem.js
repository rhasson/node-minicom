...
Modem.prototype.write = function(buf) {
  this.cmd = (typeof buf === 'string') buf : buf.toString();
...
Modem.prototype.call = function(to) {
  if (typeof to === 'string') this.sp.write('ATDT'+to);
  else return new Error('Need a phone number');
}
